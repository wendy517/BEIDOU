MYDIR=`dirname $0`
# File Name: xw_work_PGM3_02_SNVs_d0_af0.sh
# Author: XueWei
...
awk 'BEGIN{OFS="\t"}{if($7=="PASS"&&$5!~",")print $1,$2,$4,$5,$NF}' <(${dir_of_bcftools}/bcftools view -H ${work_path}/${name}_11_SNVs_strelka2_PASS.vcf.gz ) |awk 'BEGIN{OFS="\t"}{split($5,x,":"); print $1,$2,$3,$4,x[6],x[4]}' |sed 's/,/\t/g' |awk 'BEGIN{OFS="\t"}{if($7>0) print $0,$6/$7}' > ${work_path}/${name}_11_SNVs_strelka2_PASS.txt

# 12. depth ≥ 10/20 Allele Frequency ≥ 0.1
# 12.1 gatk d0_af0/d0_af0
awk 'BEGIN{OFS="\t"}{if($7>=0 && $8>=0 )print $1,$2-1,$2,$1":"$2,$0}' ${work_path}/${name}_11_SNVs_gatk_PASS.txt > ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_gatk_d0_af0.txt
# 12.2 lofreq d0_af0/d0_af0
awk 'BEGIN{OFS="\t"}{if($7>=0 && $8>=0 )print $1,$2-1,$2,$1":"$2,$0}' ${work_path}/${name}_11_SNVs_lofreq_PASS.txt > ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_lofreq_d0_af0.txt
# 12.3 Strelka2 d0_af0/d0_af0
awk 'BEGIN{OFS="\t"}{if($7>=0 && $8>=0 )print $1,$2-1,$2,$1":"$2,$0}' ${work_path}/${name}_11_SNVs_strelka2_PASS.txt > ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_strelka2_d0_af0.txt

# 13. remove dbSNP
# dbSNP151 all
{
# gatk_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(${dir_of_bcftools}/bcftools view $filtering_dbSNP_vcf -H 2>/dev/null|awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_gatk_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0.txt
...
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_gatk_d0_af0.txt ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0.sites 4 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0_rmdbSNP151.txt
}&
{
# lofreq_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(${dir_of_bcftools}/bcftools view $filtering_dbSNP_vcf -H 2>/dev/null |awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_lofreq_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0.txt
...
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_lofreq_d0_af0.txt ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0.sites 4 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0_rmdbSNP151.txt
}&
{
# strelka2_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(${dir_of_bcftools}/bcftools view $filtering_dbSNP_vcf -H 2>/dev/null|awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_strelka2_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0.txt
...
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_strelka2_d0_af0.txt ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0.sites 4 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0_rmdbSNP151.txt
}&
wait
...
# gatk_d0_af0
${dir_of_intersectBed}/intersectBed -a ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0_rmdbSNP151.txt -b ${UCSC_RepeatMask_bed} -wa -wb |cut -f 4 |sort -u > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_gatk_d0_af0_RepeatMask.sites
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0_rmdbSNP151.txt ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_gatk_d0_af0_RepeatMask.sites 4 |cut -f 1-4,7-12 > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_gatk_d0_af0_novel.txt
...
# lofreq_d0_af0
${dir_of_intersectBed}/intersectBed -a ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0_rmdbSNP151.txt -b ${UCSC_RepeatMask_bed} -wa -wb |cut -f 4 |sort -u > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_lofreq_d0_af0_RepeatMask.sites
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0_rmdbSNP151.txt ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_lofreq_d0_af0_RepeatMask.sites 4 |cut -f 1-4,7-12 > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_lofreq_d0_af0_novel.txt
...
# strelka2_d0_af0
${dir_of_intersectBed}/intersectBed -a ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0_rmdbSNP151.txt -b ${UCSC_RepeatMask_bed} -wa -wb |cut -f 4 |sort -u > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_strelka2_d0_af0_RepeatMask.sites
${dir_of_perl}/perl ${select_v_ID_pl} ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0_rmdbSNP151.txt ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_strelka2_d0_af0_RepeatMask.sites 4 |cut -f 1-4,7-12 > ${work_path}/Novel_SNVs_d0_af0/${name}_14_all_strelka2_d0_af0_novel.txt
