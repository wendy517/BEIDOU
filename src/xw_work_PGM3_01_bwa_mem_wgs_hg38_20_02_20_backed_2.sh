...
threads_ctrl_for_step12_scalpel_indels(){  
    ###### Sat Sep 19 17:19:26 CST 2020  
    count_idles=$(echo "scale=0;($(cpu_info)-5)/1"|bc)  
...
step7_HaplotypeCaller(){  
    ...
    chrn_list=(chr1 chr2 chr3 chr4 chr5 chr6 chr7 chr8 chr9 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19 chrX chrY )  
    fi  
    ...
    {  
        ...
        ${dir_of_gatk}/gatk --java-options "-Xmx30g -Xms10g -DGATK_STACKTRACE_ON_USER_EXCEPTION=true" VariantRecalibrator -R ${ref_genome_path} -V ${work_path}/${name}_07_HC.vcf.gz -O ${work_path}/${name}_08_snps.recal --resource:MGP,known=false,training=true,truth=true,prior=15.0  $MGP_vcf --resource:dbsnp,known=true,training=false,truth=false,prior=2.0 $dbsnp_vcf -an QD -an MQ -an MQRankSum -an ReadPosRankSum -an FS -an SOR -an DP --max-gaussians 4 --tranches-file ${work_path}/${name}_08_snps.tranches  -L "chr1" -L "chr2" -L "chr3" -L "chr4" -L "chr5" -L "chr6" -L "chr7" -L "chr8" -L "chr9" -L "chr10" -L "chr11" -L "chr12" -L "chr13" -L "chr14" -L "chr15" -L "chr16" -L "chr17" -L "chr18" -L "chr19"   2> >(tee ${work_path}/${name}_08_snps.log >&2)   ###### Thu Apr 23 08:56:09 CST 2020 fzc add -L ###### Tue Jul 21 14:04:29 CST 2020 deletion -L "chrM" ###### Tue Oct 27 19:40:35 CST 2020 --rscript-file ${work_path}/${name}_08_snps.R  ###### Tue Dec 1 13:20:07 CST 2020 remove -L "chrM" -L "chrY" ###### Thu Dec 3 16:59:50 CST 2020  -L "chrX" 

        # ApplyVQSR SNP  
        ${dir_of_gatk}/gatk --java-options "-Xmx30g -Xms10g -DGATK_STACKTRACE_ON_USER_EXCEPTION=true" ApplyVQSR -R ${ref_genome_path} -V ${work_path}/${name}_07_HC.vcf.gz --recal-file ${work_path}/${name}_08_snps.recal -O ${work_path}/${name}_08_snps_VQSR.vcf --tranches-file ${work_path}/${name}_08_snps.tranches -mode SNP -ts-filter-level 95 -L "chr1" -L "chr2" -L "chr3" -L "chr4" -L "chr5" -L "chr6" -L "chr7" -L "chr8" -L "chr9" -L "chr10" -L "chr11" -L "chr12" -L "chr13" -L "chr14" -L "chr15" -L "chr16" -L "chr17" -L "chr18" -L "chr19"  ###### Tue Jul 21 14:04:29 CST 2020 deletion -L "chrM" added backed ###### Mon Aug 17 09:20:44 CST 2020  added backed -L "chrM"  ###### Tue Dec 1 13:20:22 CST 2020 remove -L "chrM" -L "chrY"  ###### Thu Dec 3 16:59:50 CST 2020  -L "chrX" 
        fi  
        if [ "$mutation_type" != "SNV" ];then  
        # 8.2 INDEL  
        # VariantRecalibrator INDEL  
        ${dir_of_gatk}/gatk --java-options "-Xmx30g -Xms10g -DGATK_STACKTRACE_ON_USER_EXCEPTION=true" VariantRecalibrator -R ${ref_genome_path} -V ${work_path}/${name}_08_snps_VQSR.vcf -O ${work_path}/${name}_08_indels.recal -resource:MGP,known=true,training=true,truth=true,prior=12.0 $MGP_indel_vcf -an QD -an MQRankSum -an ReadPosRankSum -an FS -an SOR -an DP --max-gaussians 4 -mode INDEL --tranches-file ${work_path}/${name}_08_indels.tranches -L "chr1" -L "chr2" -L "chr3" -L "chr4" -L "chr5" -L "chr6" -L "chr7" -L "chr8" -L "chr9" -L "chr10" -L "chr11" -L "chr12" -L "chr13" -L "chr14" -L "chr15" -L "chr16" -L "chr17" -L "chr18" -L "chr19"    2> >(tee ${work_path}/${name}_08_indels.log >&2) ###### Tue Jul 21 14:04:29 CST 2020 deletion -L "chrM" ###### Mon Aug 17 09:20:44 CST 2020  added backed -L "chrM" ###### Tue Dec 1 13:20:22 CST 2020 remove -L "chrM"  -L "chrY" ###### Thu Dec 3 16:59:50 CST 2020  -L "chrX"  


        # ApplyVQSR INDEL  ###### Tue Oct 27 19:40:51 CST 2020 --rscript-file ${work_path}/${name}_08_indels.R 
        ${dir_of_gatk}/gatk --java-options "-Xmx30g -Xms10g -DGATK_STACKTRACE_ON_USER_EXCEPTION=true" ApplyVQSR -R ${ref_genome_path} -V ${work_path}/${name}_08_snps_VQSR.vcf --recal-file ${work_path}/${name}_08_indels.recal -O ${work_path}/${name}_08_indels_VQSR.vcf --tranches-file ${work_path}/${name}_08_indels.tranches -mode INDEL -ts-filter-level 95 -L "chr1" -L "chr2" -L "chr3" -L "chr4" -L "chr5" -L "chr6" -L "chr7" -L "chr8" -L "chr9" -L "chr10" -L "chr11" -L "chr12" -L "chr13" -L "chr14" -L "chr15" -L "chr16" -L "chr17" -L "chr18" -L "chr19" ###### Tue Jul 21 14:04:29 CST 2020 deletion -L "chrM" ###### Mon Aug 17 09:20:44 CST 2020  added backed -L "chrM"   ###### Tue Dec 1 13:20:22 CST 2020 remove -L "chrM" -L "chrY" ###### Thu Dec 3 16:59:50 CST 2020  -L "chrX" 
        fi  
    }  
    else  
